...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Button runat="server" OnClick="roundChange" CssClass="btn btn-default" Text="Submit" />
            <br />

            <!-- Table for the game's data which is hidden till a round is selected
         Each label consists of the data for each game all separated in new rows -->
