...
<!-- NOTE for chris! Your validation isn't working properly. you can still edit, update even if the error shows. Insert also isn't working
    properly because your insertion is missing the tiptime. Validation also isn't working here as well so need to fix that.

    I have added in a message below the table for when you update successfully, inserted etc. as well as errors that will show if
    SQL have conflict and such. So please fix the valiation and insert stuff
    -->
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="tipsetID" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem" OnItemInserted="ListView1_ItemInserted" OnItemUpdated="ListView1_ItemUpdated">
